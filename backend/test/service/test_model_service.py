...
def model_schema() -> schemas.Model:
    return schemas.Model(
        id=uuid.uuid4(), type="Monitor", name="Testmodel", description="Test Monitor"
    )
...
def test_get_models(mock_db, mock_crud):
    mock_crud.get_multi.return_value = [
        schemas.Model(
            id=uuid.uuid4(), type="Monitor", name="Testmodel1", description="Test Monitor1"
        ),
        schemas.Model(
            id=uuid.uuid4(), type="Monitor", name="Testmodel2", description="Test Monitor2"
        ),
    ]
